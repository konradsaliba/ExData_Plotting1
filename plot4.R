...
plot(twoday_Data$fullDate, twoday_Data$Voltage, type = "n", xlab = "datetime", ylab = "Voltage")
...
plot(twoday_Data$fullDate, twoday_Data$Global_reactive_power, type = "n", xlab = "datetime", ylab = "Global_reactive_power")
